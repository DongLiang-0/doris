...
TypeDescriptor AvroReader::convert_to_doris_type(const rapidjson::Value& column_schema) {
...
TypeDescriptor AvroReader::convert_complex_type(const rapidjson::Document::ConstObject child_schema) {
